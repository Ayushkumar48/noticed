<script lang="ts">
    ...
    let googleLoggingIn = $state(false);
    let githubLoggingIn = $state(false);
</script>
    ...
    <form>
        <div class="flex flex-col gap-6">
            <div class="flex flex-col items-center gap-2">
                ...
                <h1 class="text-xl font-bold">Welcome to Noted</h1>
            </div>
            <Button
                variant="outline"
                type="button"
